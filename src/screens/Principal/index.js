...
import { StyleSheet, Dimensions, ActivityIndicator, ToastAndroid, Platform  } from 'react-native';
...
import StatisticHistorico from '../ScreamHistorico/StatisticHistorico';
...
// Dados a serem exibidos talvez né?
    const openHist = () =>{
        dadosRecuperados.map(function(dados){
            console.log(dados.latitude);
        });
         navigation.navigate("ScreamHistorico")
    }
